...
metadata {
		definition (name: "Tasmota Plug with Power Monitoring for ST Classic V0.92", namespace: "garyjmilne", author: "Gary J. Milne")  {
		capability "Switch"
...
def checkResponse(){
	...
	for (x = 10; x >= 0; x--) {
        ...
        else
        {
            ...
            if (device.currentValue("status") != "wait") sendEvent(name:"status", value: "wait", isStateChange:true, displayed:true )
        }
    }
